...
set_input_delay -add_delay  -clock_fall -clock [get_clocks {CLK_50}]  1.000 [get_ports {CLK_50}]
...
set_clock_groups -asynchronous -group [get_clocks {SPI_SCK}] -group [get_clocks {pll|altpll_component|auto_generated|pll|clk[*]}]
